...
<section class="no-results not-found">
	...
	<header class="page-header">
		<h1 class="page-title"><?php _e( 'Nothing Found', 'structural' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'structural' ); ?></p>
			<?php get_search_form(); ?>
