...
gulp.task( 'translate', function () {   
     return gulp.src( './**/*.php')
       ...
       .pipe(wpPot( {
           domain        : 'structural',
           destFile      : 'structural.pot',
           package       : 'Structural'
       } ))
      .pipe(gulp.dest('languages/structural.pot'))
});  
...
gulp.task('clean', function() {
  return del(['images','languages/structural.pot','rtl.css']);      
}); 
...
gulp.task('watch',function(){  
  browserSync.init({  
    files: ['./**/*.php'],    
    proxy: 'http://localhost/free/structural',
  }); 
